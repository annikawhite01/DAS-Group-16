...
&\quad \text{ and the animal has a chip} \\
\beta_1 \text{ and } \beta_2 &= \text{effects of different intake types on time at shelter} \\
\beta_3 \text{ and } \beta_6 &= \text{effects of different outcome types on time at shelter} \\
...
&\quad \text{ at the shelter on time at shelter}
\end{aligned}
$$
